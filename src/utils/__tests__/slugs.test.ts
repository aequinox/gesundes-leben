...
describe('Slug Utilities', () => {
  describe('slugify', () => {
    ...
    describe('custom options', () => {
      it('should respect custom replacement character', () => {
        ...
        expect(slugify('Test String', { replacement: '.' })).toBe('test.string');
      });
    ...
    describe('error handling', () => {
      it('should throw error for non-string input', () => {
        expect(() => slugify(123 as any)).toThrow('Invalid input: string required');
        expect(() => slugify(null as any)).toThrow('Invalid input: string required');
        expect(() => slugify(undefined as any)).toThrow('Invalid input: string required');
      });
  ...
  describe('getPostSlug', () => {
    ...
    it('should handle German characters in titles', () => {
      const post = createMockPost('2024-01-01-Über die schöne deutsche Sprache');
    ...
    describe('error handling', () => {
      it('should throw error for invalid post object', () => {
        expect(() => getPostSlug(null as any)).toThrow('Invalid post object or missing title');
        expect(() => getPostSlug(undefined as any)).toThrow('Invalid post object or missing title');
        expect(() => getPostSlug({} as any)).toThrow('Invalid post object or missing title');
      });

      it('should throw error for post without data', () => {
        const invalidPost = { id: 'test' } as any;
        expect(() => getPostSlug(invalidPost)).toThrow('Invalid post object or missing title');
      });
      ...
      it('should throw error for post without title', () => {
        ...
        expect(() => getPostSlug(postWithoutTitle)).toThrow('Invalid post object or missing title');
      });

      it('should throw error for post with empty title', () => {
        const postWithEmptyTitle = createMockPost('');
        expect(() => getPostSlug(postWithEmptyTitle)).toThrow('Invalid post object or missing title');
      });
    });
  });
  ...
  describe('Edge Cases', () => {
    describe('slugify edge cases', () => {
      ...
      it('should handle consecutive special characters', () => {
        ...
        expect(slugify('Spaces   And   More   Spaces')).toBe('spaces-and-more-spaces');
      });
    ...
    describe('getPostSlug edge cases', () => {
      ...
      it('should handle very long titles', () => {
        ...
        expect(result).toBe(longTitle.substring(11).trim().toLowerCase().replace(/\\s+/g, '-'));
      });
    });
  ...
  describe('Performance', () => {
    it('should handle large arrays efficiently', () => {
      const largeArray = Array.from({ length: 1000 }, (_, i) => `Test String ${i}`);
