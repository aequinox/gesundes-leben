...
references:
  - "2010-wan-taurine-oat-fiber-intestinal-endotoxin"
  - "deanna-minich-fibers-remove-toxins"
  - "2023-salvatore-dietary-fibers-healthy-children-pediatric"
  - "2023-zitvogel-dietary-fibers-gastrointestinal-immunity"
  - "2021-gill-dietary-fiber-gastrointestinal-health"
  - "2021-guan-soluble-dietary-fiber-gut-microbiota"
  - "2020-dayib-dietary-fibers-obesity-disorders"
  - "2020-koper-gut-health-immunomodulatory-food-compounds-wageningen"
  - "2018-borewicz-microbiota-modulation-prebiotics-wageningen"
  - "2016-rosch-fermentation-immunomodulating-dietary-fibres-wageningen"
---
...
import BallaststoffeVegetablesImage from "./images/pexels-ella-olsson-1640777.jpg";
import ToiletPaperImage from "./images/Depositphotos_77377864_XL-679x1024.jpg";
import ConstipationImage from "./images/Depositphotos_130060630_XL-677x1024.jpg";
...
<Image
  src={BallaststoffeVegetablesImage}
...
>
  Wer Ballaststoffe nicht gewohnt ist, sollte sie bei einer Ernährungsumstellung
  zuerst in kleinen Mengen essen. Es ist ratsam, Präbiotika und vor allem
  Inulin-haltige Präparate einzuschleichen und entsprechendes Gemüse nur in
  Maßen zu genießen, denn wer wenig Ballaststoffe isst, kann darauf mit
  Blähungen reagieren. Und das ist unangenehm und nicht immer
  gesellschaftsfähig.
</Blockquote>
