...
heroImage:
  ...
  alt: ""
references:
  - "2012-kacimi-intermittent-fasting-cytokines"
  - "2014-vasconcelos-intermittent-fasting-neuroinflammation"
  - "2007-varady-alternate-day-fasting-chronic-disease"
  - "2010-alirezaei-short-term-fasting-autophagy"
  - "2007-anderson-metabolic-markers-diabetes-cardiovascular"
  - "2007-aksungar-intermittent-fasting-inflammation"
  - "2014-nakamura-fasting-hypersensitivity-ketones"
  - "2004-nakamura-hypersensitivity-suppression"
  - "2013-li-intermittent-fasting-cognitive-function"
  - "1999-lanzi-growth-hormone-insulin"
  - "1999-ji-insulin-growth-hormone-signaling"
  - "2010-buschemeyer-intermittent-fasting-prostate-cancer"
  - "2013-rogozina-intermittent-calorie-restriction-mammary"
draft: false
---
...
import FastingMethodsImage from "./images/Intermittierendes-Fasten-5-Moeglichkeiten-724x1024.jpg";
import KetosisImage from "./images/Wie-funktioniert-Ketose-1024x1024.jpg";
import FastingBenefitsImage from "./images/Intermittierendes-Fasten-5-Vorteile-724x1024.jpg";
import FastingGiftImage from "./images/Fasten-als-Geschenk-an-dich-410x1024.jpg";
import SandraPfeifferAvatar from "./images/sandra-pfeiffer.png";
...
<Blockquote author="Platon" role="Griechischer Philosoph (ca. 428-348 v. Chr.)">
...
<Image
  src={FastingMethodsImage}
  alt="Zwei Frauen, die in einem Fitnessraum trainieren, mit darübergelegten Textblöcken, die verschiedene Gesundheits- und Ernährungstipps aufhören."
  title="Foto von Bruce Mars auf Unsplash"
  position="center"
/>
...
<Image
  src={KetosisImage}
  alt="Infografik über den Vergleich von traditioneller und ketogener Ernährung und deren Auswirkungen auf den Blutzucker und die Energiegewinnung."
  position="center"
/>
...
>
> Hippokrates von Kos - Der Vater der modernen Medizin (ca. 460-370 v. Chr.)

<Blockquote
  author="Hippokrates von Kos"
  role="Der Vater der modernen Medizin (ca. 460-370 v. Chr.)"
>
  Wer stark, gesund und jung bleiben will, sei mäßig, übe den Körper, atme reine
  Luft und heile sein Weh eher durch Fasten als durch Medikamente.
</Blockquote>

## 5 Vorteile des Intermittierenden Fastens

Eine gesunde Ernährung mit viel <InternalLink href="/posts/top-11-entzuendungshemmende-lebensmittel/" variant="inline" context="strong">entzündungshemmenden Lebensmitteln</InternalLink> führt zu deutlich weniger Entzündungen als eine ungesunde Ernährung, die zum Beispiel aus viel Fast Food, einfachen Kohlenhydraten oder auch <InternalLink href="/posts/hochverarbeitete-lebensmittel-upfs/" variant="inline" context="moderate">hochverarbeiteten Lebensmitteln</InternalLink> besteht. Es ist jedoch wichtig zu verstehen, dass wir immer, wenn wir Nahrung zu uns nehmen, damit auch das Entzündungsniveau im Körper erhöhen, als Reaktion des Immunsystems auf zugeführte Substanzen. Je schwerer also eine Mahlzeit zu verdauen ist, desto mehr entzündliche Aktivität wird sie hervorrufen.
...
<Image
  src={FastingBenefitsImage}
  alt="Infografik: Vorteile des intermittierenden Fastens mit Wecker im Hintergrund."
  title="Foto von Towfiqu Barbhuiya auf Unsplash"
  position="center"
/>
...
<Blockquote 
  author="Sandra Pfeiffer"
  role="Heilpraktikerin, Systemische Therapeutin, Mediatorin & Traumatherapeutin"
  avatar={SandraPfeifferAvatar.src}
...
<ContextualLinks
  currentPostSlug="intermittierendes-fasten-top-5-gesundheitliche-vorteile"
...
<Image
  src={FastingGiftImage}
  alt="Infografik über Fasten als Geschenk an dich selbst"
  position="center"
/>
