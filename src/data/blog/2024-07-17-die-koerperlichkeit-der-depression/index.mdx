...
modDatetime: 2025-05-06T09:45:48Z
draft: false
featured: false
group: fragezeiten
categories:
...
references:
  - "2021-uke-copsy-study-child-mental-health"
  - "2021-uke-pressemitteilung-kinder-corona-psyche"
  - "2024-destatis-depression-kinder-jugendliche"
  - "1991-cohen-psychological-stress-common-cold"
  - "2002-kroenke-phq15-somatic-symptoms"
  - "2023-li-depression-parkinsons-disease"
  - "2015-de-koning-vitamin-d-depression-older-adults"
  - "2001-ledochowski-fructose-malabsorption-tryptophan"
  - "2016-skovlund-hormonal-contraception-depression"
  - "2011-verbeek-beta-blockers-depression-review"
  - "2014-walsh-nutrient-power"
  - "2005-marqueling-isotretinoin-depression-review"
  - "2017-hertel-oral-contraceptives-hpa-axis"
  - "2023-lai-interferon-therapy-depression"
  - "2005-moncrieff-antidepressant-efficacy-adults"
  - "2011-fava-antidepressant-tolerance-mechanisms"
  - "2007-berk-vitamin-d-depression-role"
  - "2019-briggs-vitamin-d-depression-older-adults"
  - "2016-vaziri-vitamin-d-perinatal-depression"
  - "2017-li-magnesium-calcium-depression-meta-analysis"
  - "2010-sawada-zinc-supplementation-mood"
  - "2015-solati-zinc-bdnf-depression-trial"
  - "2020-noorwali-dietary-factors-depression-review"
  - "2009-sanchez-villegas-mediterranean-diet-depression"
  - "2020-gostner-tryptophan-metabolism-psychoneuroimmunology"
  - "2017-sharma-same-neuropsychiatric-review"
  - "2015-bhat-omega3-depression-review"
  - "2012-bloch-omega3-depression-meta-analysis"
  - "2017-pinto-sanchez-probiotics-depression-ibs"
  - "2000-babyak-exercise-depression-maintenance"
  - "2011-groeber-mikronaehrstoffe-metabolic-tuning"
---
...
import AyurvedaImage from "./images/kombiniere_Ayurveda_Diese_indische_Medizinlehre__meh_c86d2f0d-ac43-42e3-9422-77abe084b93f.png";
import FreudImage from "./images/Psychologie_Sigmund_Freud_18561939_der_Begrunder_der_76ae2ec3-7f6f-4d69-b59b-049ddd5708a8.png";
import NeuroscienceWaveImage from "./images/Watercolor_Brushstroke_Neuroscience_Wordmark_Neurosc_46a85804-ad2d-4e70-b89c-802cbd986771-1024x256.png";
import WinWinImage from "./images/funny_image_of_a_win-win-situation_happy_people_4c2f06b7-613e-4d92-b20b-2882a4063c53-1024x256.png";
import VitaminsImage from "./images/banner_image_of_healthy_vitamins_minerals_and_trace__04a6a1c5-c068-49ff-9c32-718f2771fda5-1024x256.png";
import BadNutritionDepressionImage from "./images/Depressiv_durch_schlechte_Ernahrung_Als_logische_Kon_4b6d46e9-b95d-451d-b718-9f301a295773-1024x256.png";
import HealthyGutImage from "./images/healthy_gut_healthy_life_1e6ce7ad-5c02-4489-935b-9cb48a912723-1024x256.png";
import LabAnalysisImage from "./images/Laborchemische_Analyse_der_Vitamin-_und_Mineralstoff_40fc9f3a-f755-4bce-a116-d531e0224825-1024x256.png";
import SevenFactorsImage from "./images/a_stylish_number_7_build_out_healthy_food_sourrounde_6f490717-d523-482a-91a4-1bbf3ee4e0e3.png";
...
<List
  title="Merkmale einer manifesten (sichtbaren) Depression"
  subtitle=""
  items={[
    { content: "Appetitlosigkeit (evtl. mit Gewichtsverlust)" },
    { content: "Innere Unruhe" },
    {
      content: "Angst, häufig unspezifisch",
    },
    { content: "Durchschlafstörungen mit nächtlichem Gedankenkreisen" },
    { content: "Stimmungstief beim Aufwachen" },
    { content: "Verlust von Freude und Genussfähigkeit" },
    { content: "Minderwertigkeitsgefühle" },
    { content: "Alles ist zu viel." },
    { content: "Antriebslosigkeit" },
    { content: "Anhaltende Niedergeschlagenheit" },
    { content: "Traurigkeit" },
    { content: "Erschöpfung" },
    { content: "Verlust von Interessen" },
    { content: "Innere Leere" },
    { content: "Die Symptome halten länger als (ca.) 3–4 Wochen an" },
  ]}
/>

<ContextualLinks
  currentPostSlug="die-koerperlichkeit-der-depression"
  title="Verwandte Artikel zu mentaler Gesundheit"
  maxLinks={4}
/>
...
<ImageComponent
  src={AyurvedaImage}
  alt="Ayurveda und ganzheitliche Medizin Illustration"
...
<ImageComponent
  src={FreudImage}
  alt="Sigmund Freud hält nachdenklich die Hände zusammen. Im Hintergrund sind Büstenskulpturen zu sehen."
  title="Bild von Sigmund Freud, KI-generiert"
  position="right"
/>
...
<ImageComponent
  src={NeuroscienceWaveImage}
  alt="Ein abstraktes Bild mit einer horizontalen Welle aus bunten, rauchähnlichen Wirbeln, die auf einem weißen Hintergrund nahtlos von Rot, Orange, Gelb, Grün, Blau zu Lila übergehen."
  title="Bild KI-generiert"
  position="center"
/>
...
<ImageComponent
  src={WinWinImage}
  alt="Zwei Orangen mit darauf gemalten Smileys liegen auf einer nassen Holzoberfläche, überall sind Wassertropfen verstreut – ein fröhlicher Kontrapunkt zu jedem Anflug von Depression."
  title="Bild KI-generiert"
  position="center"
/>
...
<ImageComponent
  src={VitaminsImage}
  alt="Auf einer Holzoberfläche präsentiert sich eine Auswahl an Obst, Gemüse und verschiedenfarbigen Pillen gegen Depressionen."
  title="Bild KI-generiert"
  position="center"
/>
...
<ImageComponent
  src={BadNutritionDepressionImage}
  alt="Depressiv durch schlechte Ernährung - Zusammenhang zwischen Ernährung und psychischer Gesundheit"
  title="Bild KI-generiert"
  position="left"
/>
...
<ImageComponent
  src={HealthyGutImage}
  alt="Healthy Gut, Healthy Life - Gesunder Darm, gesundes Leben"
  title="Bild KI-generiert"
  position="right"
/>
...
<ImageComponent
  ...
  alt="Laborchemische Analyse der Vitamin- und Mineralstoffversorgung"
  title="Bild KI-generiert"
  position="center"
/>
...
<ImageComponent
  src={SevenFactorsImage}
  alt="Die Zahl Sieben wird mit verschiedenen Obst- und Gemüsesorten sowie Menschen illustriert, die verschiedenen Tätigkeiten rund um und auf den Produkten nachgehen."
  title="Bild KI-generiert"
  position="center"
/>
