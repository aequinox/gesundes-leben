 ...
 * @property {string} type - Option type (boolean, file, folder)
 * @property {string} description - Option description
 * @property {*} default - Default value
 * @property {string[]} [aliases] - Alternative option names
 * @property {string} [prompt] - Prompt type for wizard
 * @property {function} [coerce] - Value coercion function
 * @property {function} [validate] - Value validation function
 * @property {boolean} [isProvided] - Whether option was provided via CLI
 */
 ...
 * @param {string[]} argv - Command line arguments
 * @returns {commander.Command} Parsed command object
 */
...
function validateFile(value) {
  ...
  try {
    ...
    console.error('Error validating file:', _ex);
    isValid = false;
  }
