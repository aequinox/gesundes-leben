 ...
 * ```
 */
export async function convertXmlToMdx(config: Partial<XmlConverterConfig>): Promise<ConversionResult> {
...
export async function convertXmlToMdxWithErrorHandling(
  ...
  try {
    ...
    const context = error instanceof XmlConversionError ? error.context : undefined;
